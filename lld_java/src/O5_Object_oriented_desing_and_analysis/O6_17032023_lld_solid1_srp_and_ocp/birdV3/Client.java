...
public class Client {
    public static void main(String[] args) {
        ...
        O5_Object_oriented_desing_and_analysis.O6_17032023_lld_solid1_srp_and_ocp.birdV2.Crow crow = new Crow();
        crow.eat();
        crow.fly();

        O5_Object_oriented_desing_and_analysis.O6_17032023_lld_solid1_srp_and_ocp.birdV2.Eagle eagle = new Eagle();
        eagle.eat();
        eagle.fly();

        O5_Object_oriented_desing_and_analysis.O6_17032023_lld_solid1_srp_and_ocp.birdV2.Penguin penguin = new Penguin();
        penguin.eat();
        penguin.fly();

        O5_Object_oriented_desing_and_analysis.O6_17032023_lld_solid1_srp_and_ocp.birdV2.Pigeon pigeon = new Pigeon();
        pigeon.eat();
        pigeon.fly();

        O5_Object_oriented_desing_and_analysis.O6_17032023_lld_solid1_srp_and_ocp.birdV2.Sparrow sparrow = new Sparrow();
        sparrow.eat();
        sparrow.fly();

        O5_Object_oriented_desing_and_analysis.O6_17032023_lld_solid1_srp_and_ocp.birdV2.Vulture vulture = new Vulture();
        vulture.eat();
        vulture.fly();
